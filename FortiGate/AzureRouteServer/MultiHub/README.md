## Multi Hub demo with Azure Route Server
...
`cd ~/clouddrive/ && wget -qO- https://github.com/fortinet/azure-templates/archive/main.tar.gz | tar zxf - && cd ~/clouddrive/azure-templates-main/FortiGate/AzureRouteServer/MultiHub/ && ./deploy.sh`
